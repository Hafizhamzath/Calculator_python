...
window =  Tk()
window.title("CALCULATOR") #Title() is used to give the title for the window
window.geometry("570x600+100+200") #Geometry () is used to specify the size of the window
window.resizable(False,False) #resizable() is used to give instruction wheather it has to be resized horizonatally or vertically
window.configure(bg="#17161b")  #Configure() is used to modify the options of the widget
...
label_result = Label(window,width=25, height=2,text="",font=("arial",30)) #label() is a widget in tkinter that displays the text or image on the screen  
label_result.pack() #pack() is used to add widgets to the screen
